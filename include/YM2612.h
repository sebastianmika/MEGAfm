...
class YM2612 {
	public:
		void setup(uint8_t ic_pin, uint8_t cs_pin, uint8_t wr_pin, uint8_t rd_pin, uint8_t a0_pin, uint8_t a1_pin,
...
| 26H  | Timer B                            |     |                         |         |            | |              | |
+------+------------------------------------+-----+-------------------------+---------+------------+------------------------------------+--------------+--------+
| 27H  | Ch3 mode                           |     | Reset B                 | Reset A | Enable B   | Enable A | Load B
| Load A |
+------+------------------------------------+-----+-------------------------+---------+------------+------------------------------------+--------------+--------+
...
+------+------------------------------------+-----+-------------------------+---------+------------+------------------------------------+--------------+--------+
| A4H+ |                                    |     | Block                   |         |            | Frequency Number
MSB               |              |        |
+------+------------------------------------+-----+-------------------------+---------+------------+------------------------------------+--------------+--------+
| A8H+ | Ch3 supplementary frequency number |     |                         |         |            | |              | |
+------+------------------------------------+-----+-------------------------+---------+------------+------------------------------------+--------------+--------+
| ACH+ |                                    |     | Ch3 supplementary block |         |            | Ch3 supplementary
frequency number |              |        |
+------+------------------------------------+-----+-------------------------+---------+------------+------------------------------------+--------------+--------+
...
Here is C code to calculate an array with all of the above frequencies (ie, so that midi[0], which is midi note #0, is
assigned the value of 8.1757989156). Tuning is based upon A=440.
